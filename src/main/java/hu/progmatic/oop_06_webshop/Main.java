...
public class Main {
    public static void main(String[] args) {
        ...
        Product product2 = new Product("Nesze semmi fogd meg jól", 4000);
        Product product3 = new Product("Termék 3", 4000);
        Product product3_v2 = new Product("Termék 3", 5500);
        ...
        Product productAlma = new Product("Alma", 4000);
        Product productBanan = new Product("Banán", 4000);
        Product productAfonya = new Product("Áfonya", 4000);
        ...
        webshop.updateProduct(productAlma);
        webshop.updateProduct(productBanan);
        webshop.updateProduct(productAfonya);
